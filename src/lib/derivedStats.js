...
export function startingAttributes(weights) {
  return {
...
export function attributesAfterLevelUp(attrs, weights, levels = 1) {
  return {
...
export function derivedPools(attrs, attrBonus = {}, poolBonus = {}) {
